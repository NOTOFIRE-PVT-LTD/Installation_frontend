...
import { downloadReceiveImportTemplate } from '../../utils/stockReceiveImport';

export default function StockReceiveImportDialog({ open, onClose, onSubmit, submitting, result, error }) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Import Receive from Supplier</DialogTitle>
      <DialogContent>
...
Cable          | 6mm wire           | ABC Traders    | 1500   | 10       | 2026-09-07 | CH-001                   | Sample`}
          ...
          <Button
            ...
            onClick={() => {
              downloadReceiveImportTemplate().catch(() => {});
            }}
          >
